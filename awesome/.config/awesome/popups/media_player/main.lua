...
local artist_widget = wibox.widget({
	markup = '<span color="' .. color.white .. '" font="Ubuntu Nerd Font 14">' .. "Unknown Artist" .. "</span>",
	align = "center",
	valign = "bottom",
	widget = wibox.widget.textbox,
...
playerctl:connect_signal("metadata", function(_, title, artist, album_path, album, new, player_name)
	...
	title_widget:set_markup_silently(
		'<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 8 bold">' .. title .. "</span>"
	)
	artist_widget:set_markup_silently(
		'<span color="' .. color.white .. '" font="Ubuntu Nerd Font 11">' .. artist .. "</span>"
	)
end)
...
local length_text = wibox.widget({
	markup = '<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 11">' .. "00:00" .. "</span>",
	align = "center",
	valign = "top",
	widget = wibox.widget.textbox,
	font = "CaskaydiaCove Nerd Font 12",
	...
	awful.spawn.easy_async("timeout 0.4s playerctl -F metadata -f '{{mpris:length}}'", function(stdout)
		if stdout == "" then
			...
			length_text:set_markup_silently(
				'<span color="' .. color.blueish_white .. '" font="Ubuntu Nerd Font 11">' .. text .. "</span>"
			)
...
local button = wibox.widget({
	image = os.getenv("HOME") .. "/.config/awesome/popups/media_player/assets/play2.png",
	resize = true,
	forced_height = dpi(40),
	forced_width = dpi(40),
	widget = wibox.widget.imagebox,
