...
vim.keymap.set("n", "wd", ":Telescope diagnostics<CR>")
vim.keymap.set("n", "ws", ":Telescope project<CR>")
...
require('telescope').setup({
	defaults = {
		...
		-- config_key = value,
		-- ..
		vimgrep_arguments = { 'rg', '--hidden', '--color=never', '--no-heading', '--with-filename', '--line-number', '--column',
			'--smart-case' },
		prompt_prefix = "> ",
		mappings = {
			i = {
